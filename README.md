...
The operator sandbox addresses operation engineers with an environment for the design and optimization of systems that should be migrated to a hybrid cloud. It represents a different approach to adopt infrastructure as code. The benefits of programmable infrastructure are out of question, but the toolset that is commonly used today, yield limited benfits in an enterprise environment. Cloud engineers employ a combination of applications like Terraform, Ansible and Kubernetes to automate system configurations, topology designs and container deployments. Yet configuration management systems, infrastructure-as-code and container platforms serve a similar purpose and overlap significantly in functionality. The focus is on provisioning and deployment not on automating management processes. While this is applicable for cloud service provider developing cloud-native applications, it rises complexity for service operator managing large quantities of applications from different vendors and aiming to outsource mainly infrastructure operations to a thrid party, but retaining control over their applications for technical, commercial or regulatory reasons. Code interpreters that do not separate system definitions and execution instructions, make it hard to scale an organization with a separation of duties between design, implementation and operation. And ensuring regulatory compliance, security and commercial justification without a separation between command and control remains doubtful. Delivering on the promise of continuous integrations and deployments requires an integrated toolchain with a common data source for system definitions and execution modules, separating engineering tasks along delivery milestones like operational readiness, fulfillment and assurance. 
