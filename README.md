...
* *Report bugs* If you find a bug, please [open an issue](URL github create issue) with a clear description of the problem.
* *Fix bugs* If you know how to fix a bug, submit a [pull request](URL git pull request) with your changes.
* *Improve documentation* If you find the documentation lacking, you can contribute improvements by editing the relevant files.
* *Add new features* If you have an idea for a new feature, please [open an issue](URL github create issue) to discuss it before creating a pull request.
